...
import (
	...
	"github.com/instill-ai/connector/pkg/airbyte/v1"
	"github.com/instill-ai/connector/pkg/archetypeai/v1"
	"github.com/instill-ai/connector/pkg/bigquery/v1"
	"github.com/instill-ai/connector/pkg/googlecloudstorage/v1"
	"github.com/instill-ai/connector/pkg/googlesearch/v1"
	"github.com/instill-ai/connector/pkg/huggingface/v1"
	"github.com/instill-ai/connector/pkg/instill/v1"
	"github.com/instill-ai/connector/pkg/numbers/v1"
	"github.com/instill-ai/connector/pkg/openai/v1"
	"github.com/instill-ai/connector/pkg/pinecone/v1"
	"github.com/instill-ai/connector/pkg/redis/v1"
	"github.com/instill-ai/connector/pkg/restapi/v1"
	"github.com/instill-ai/connector/pkg/stabilityai/v1"
	"github.com/instill-ai/connector/pkg/website/v1"
